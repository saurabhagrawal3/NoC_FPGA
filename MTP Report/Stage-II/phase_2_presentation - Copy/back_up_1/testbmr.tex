...
\title{LDPC Decoder Implementation on NoC}    % Enter your title between curly braces
\author{Shaishav Yogeshkumar Shah (133070050)}                 % Enter your name between curly braces
\institute{Guides by: Prof. Sachin B. Patkar, Dept. of EE, IIT Bombay}      % Enter your institute name between curly braces
