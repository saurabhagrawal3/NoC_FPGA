...
//
// On Sat Oct  4 06:03:14 EDT 2014
//
...
module mkSepRouterAllocator_1(pipeline,
			    CLK,
			    RST_N,
  ...
  // submodule inputArbs
  mkRouterInputArbitersRoundRobin_1 inputArbs(.CLK(CLK),
					    .RST_N(RST_N),
  ...
  mkRouterOutputArbitersRoundRobin_1 outputArbs(.CLK(CLK),
					      .RST_N(RST_N),
