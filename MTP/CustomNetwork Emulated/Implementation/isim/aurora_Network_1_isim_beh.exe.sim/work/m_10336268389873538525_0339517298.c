...
#endif
static const char *ng0 = "/root/Desktop/MTP/CustomNetwork Emulated/3R_Custom/build/module_outport_encoder.v";
...
LAB49:    memcpy(t160, t129, 8);

LAB50:    xsi_vlogtype_concat(t3, 3, 3, 2U, t160, 1, t4, 2);
    t188 = (t0 + 2760);
    t189 = (t188 + 56U);
    t190 = *((char **)t189);
    t191 = (t190 + 56U);
    ...
    *((unsigned int *)t198) = (t200 | t194);
    xsi_driver_vfirst_trans(t188, 0, 2);
    t201 = (t0 + 2680);
    *((int *)t201) = 1;
...
LAB12:    xsi_vlog_unsigned_bit_combine(t4, 2, t26, 2, t31, 2);
    goto LAB16;
...
LAB25:    xsi_vlog_unsigned_bit_combine(t31, 2, t54, 2, t59, 2);
    goto LAB29;
...
LAB52:    if (*((unsigned int *)t153) != 0)
        goto LAB53;

LAB54:    t161 = *((unsigned int *)t129);
...
extern void work_m_10336268389873538525_0339517298_init()
{
	static char *pe[] = {(void *)Cont_68_0};
	xsi_register_didat("work_m_10336268389873538525_0339517298", "isim/aurora_Network_1_isim_beh.exe.sim/work/m_10336268389873538525_0339517298.didat");
