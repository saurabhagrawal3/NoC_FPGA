...
//
// On Sat Oct  4 06:34:10 EDT 2014
//
...
module mkIQRouterCoreSimple_2(CLK,
			    RST_N,
  ...
  reg [14 : 0] IF_IF_outport_encoder_45_BIT_3_46_THEN_IF_outp_ETC___d845,
  ...
  wire [14 : 0] IF_IF_outport_encoder_45_BIT_3_46_THEN_NOT_out_ETC___d390,
  ...
  mkInputQueue_2 flitBuffers(.CLK(CLK),
			   .RST_N(RST_N),
  ...
  mkInputQueue_2 flitBuffers_1(.CLK(CLK),
			     .RST_N(RST_N),
  ...
  mkInputQueue_2 flitBuffers_2(.CLK(CLK),
			     .RST_N(RST_N),
  ...
  mkInputQueue_2 flitBuffers_3(.CLK(CLK),
			     .RST_N(RST_N),
  ...
  mkInputQueue_2 flitBuffers_4(.CLK(CLK),
			     .RST_N(RST_N),
  ...
  mkOutPortFIFO_2 outPortFIFOs(.CLK(CLK),
			     .RST_N(RST_N),
  ...
  mkOutPortFIFO_2 outPortFIFOs_1(.CLK(CLK),
			       .RST_N(RST_N),
  ...
  mkOutPortFIFO_2 outPortFIFOs_2(.CLK(CLK),
			       .RST_N(RST_N),
  ...
  mkOutPortFIFO_2 outPortFIFOs_3(.CLK(CLK),
			       .RST_N(RST_N),
  ...
  mkOutPortFIFO_2 outPortFIFOs_4(.CLK(CLK),
			       .RST_N(RST_N),
  ...
  mkSepRouterAllocator_2 routerAlloc(.pipeline(1'd0),
				   .CLK(CLK),
				   .RST_N(RST_N),
  ...
  // remaining internal signals
  module_outport_encoder_2 instance_outport_encoder_0(.outport_encoder_vec({ { 1'd1 &&
  ...
  module_outport_encoder_2 instance_outport_encoder_1(.outport_encoder_vec({ { 1'd1 &&
  ...
  module_outport_encoder_2 instance_outport_encoder_2(.outport_encoder_vec({ { 1'd1 &&
  ...
  module_outport_encoder_2 instance_outport_encoder_3(.outport_encoder_vec({ { 1'd1 &&
  ...
  module_outport_encoder_2 instance_outport_encoder_4(.outport_encoder_vec({ { 1'd1 &&
  ...
  assign IF_IF_outport_encoder_45_BIT_3_46_THEN_NOT_out_ETC___d360 =
	     IF_outport_encoder_45_BIT_3_46_THEN_NOT_outpor_ETC___d811 ?
	       outport_encoder___d829[3] && hasFlitsToSend_perIn_3$wget[15] :
	       !outport_encoder___d828[3] ||
	       outport_encoder___d828[2:0] != 3'd0 ||
	       hasFlitsToSend_perIn_4$wget[15] ;
  assign IF_IF_outport_encoder_45_BIT_3_46_THEN_NOT_out_ETC___d361 =
	     IF_outport_encoder_45_BIT_3_46_THEN_NOT_outpor_ETC___d810 ?
	       outport_encoder___d830[3] && hasFlitsToSend_perIn_2$wget[15] :
	       IF_IF_outport_encoder_45_BIT_3_46_THEN_NOT_out_ETC___d360 ;
  assign IF_IF_outport_encoder_45_BIT_3_46_THEN_NOT_out_ETC___d362 =
	     IF_outport_encoder_45_BIT_3_46_THEN_NOT_outpor_ETC___d809 ?
	       outport_encoder___d831[3] && hasFlitsToSend_perIn_1$wget[15] :
	       IF_IF_outport_encoder_45_BIT_3_46_THEN_NOT_out_ETC___d361 ;
  assign IF_IF_outport_encoder_45_BIT_3_46_THEN_NOT_out_ETC___d363 =
	     IF_outport_encoder_45_BIT_3_46_THEN_NOT_outpor_ETC___d792 ?
	       outport_encoder___d832[3] && hasFlitsToSend_perIn$wget[15] :
	       IF_IF_outport_encoder_45_BIT_3_46_THEN_NOT_out_ETC___d362 ;
