...
COPY aurora_8b10b_v5_3_example_design.edf .\results\

ECHO Copying files from example design directory to the results directory
COPY ..\example_design\aurora_8b10b_v5_3_example_design.ucf .\results\
CD results
...
ngdbuild aurora_8b10b_v5_3_example_design

REM  -----------------------------------------------------------------------------
REM-------------------------------Run map-------------------------------------------

ECHO 'Running map'
map -detail aurora_8b10b_v5_3_example_design -o mapped.ncd
...
ECHO INFO:Implementation is complete for aurora_8b10b_v5_3_example_design
