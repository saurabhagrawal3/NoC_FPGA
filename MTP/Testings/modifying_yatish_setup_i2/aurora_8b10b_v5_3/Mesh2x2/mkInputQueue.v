...
//
// On Thu Jun  5 09:11:32 EDT 2014
//
    ...
    if (!RESET)
      ...
      begin
			if (inputQueue_ifc_mf_ifc_heads$EN)
				inputQueue_ifc_mf_ifc_heads <= `BSV_ASSIGNMENT_DELAY inputQueue_ifc_mf_ifc_heads$D_IN;
			if (inputQueue_ifc_mf_ifc_not_empty$EN)
				inputQueue_ifc_mf_ifc_not_empty <= `BSV_ASSIGNMENT_DELAY inputQueue_ifc_mf_ifc_not_empty$D_IN;
			if (inputQueue_ifc_mf_ifc_not_full$EN)
				inputQueue_ifc_mf_ifc_not_full <= `BSV_ASSIGNMENT_DELAY inputQueue_ifc_mf_ifc_not_full$D_IN;
			if (inputQueue_ifc_mf_ifc_tails$EN)
				inputQueue_ifc_mf_ifc_tails <= `BSV_ASSIGNMENT_DELAY inputQueue_ifc_mf_ifc_tails$D_IN;
			end
		end
...
//  begin
//    #0;
//    if (RESET) if (EN_enq && !inputQueue_ifc_mf_ifc_not_full) $write("");
//    if (RESET) if (EN_enq && !inputQueue_ifc_mf_ifc_not_full) $write("");
//    if (RESET)
...
//    if (RESET) if (EN_enq && !inputQueue_ifc_mf_ifc_not_full) $finish(32'd0);
//    if (RESET) if (EN_enq) $write("");
//    if (RESET)
...
//    if (RESET) if (EN_deq && !inputQueue_ifc_mf_ifc_not_empty) $finish(32'd0);
//    if (RESET) if (EN_deq) $write("");
//    if (RESET)
