...
//
// On Thu Jun  5 09:11:42 EDT 2014
//
...
module mkRouterCoreSimple(CLK,
  ...
  reg [19 : 0] IF_IF_outport_encoder_37_BIT_3_38_THEN_IF_outp_ETC___d1162,
  ...
  wire [19 : 0] IF_IF_outport_encoder_37_BIT_3_38_THEN_NOT_out_ETC___d1161,
  ...
  assign IF_IF_outport_encoder_37_BIT_3_38_THEN_NOT_out_ETC___d1171 =
	     IF_outport_encoder_37_BIT_3_38_THEN_NOT_outpor_ETC___d1083 ?
	       !outport_encoder___d1152[3] || !hasFlitsToSend_perIn$wget[20] :
	       IF_IF_outport_encoder_37_BIT_3_38_THEN_NOT_out_ETC___d582 ;
  ...
  assign IF_IF_outport_encoder_37_BIT_3_38_THEN_NOT_out_ETC___d593 =
	     IF_outport_encoder_37_BIT_3_38_THEN_NOT_outpor_ETC___d1126 ?
	       outport_encoder___d1149[3] && hasFlitsToSend_perIn_3$wget[20] :
	       !outport_encoder___d1148[3] ||
	       outport_encoder___d1148[2:0] != 3'd0 ||
	       hasFlitsToSend_perIn_4$wget[20] ;
  assign IF_IF_outport_encoder_37_BIT_3_38_THEN_NOT_out_ETC___d594 =
	     IF_outport_encoder_37_BIT_3_38_THEN_NOT_outpor_ETC___d1125 ?
	       outport_encoder___d1150[3] && hasFlitsToSend_perIn_2$wget[20] :
	       IF_IF_outport_encoder_37_BIT_3_38_THEN_NOT_out_ETC___d593 ;
  assign IF_IF_outport_encoder_37_BIT_3_38_THEN_NOT_out_ETC___d595 =
	     IF_outport_encoder_37_BIT_3_38_THEN_NOT_outpor_ETC___d1124 ?
	       outport_encoder___d1151[3] && hasFlitsToSend_perIn_1$wget[20] :
	       IF_IF_outport_encoder_37_BIT_3_38_THEN_NOT_out_ETC___d594 ;
  ...
  begin
    #0;
    if (RESET) if (EN_out_ports_0_putNonFullVCs) $write("");
    if (RESET) if (EN_out_ports_0_putNonFullVCs) $write("");
    if (RESET) if (EN_out_ports_1_putNonFullVCs) $write("");
    if (RESET) if (EN_out_ports_1_putNonFullVCs) $write("");
    if (RESET) if (EN_out_ports_2_putNonFullVCs) $write("");
    if (RESET) if (EN_out_ports_2_putNonFullVCs) $write("");
    if (RESET) if (EN_out_ports_3_putNonFullVCs) $write("");
    if (RESET) if (EN_out_ports_3_putNonFullVCs) $write("");
    if (RESET) if (EN_out_ports_4_putNonFullVCs) $write("");
    if (RESET) if (EN_out_ports_4_putNonFullVCs) $write("");
    if (RESET)
